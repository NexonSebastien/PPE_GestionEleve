			...
			<div id="page">
				...
				switch ($page) {
					...
					case "insertion" :
						...
						break;
					case "insertionEleve" :
						include ("VUES/recuperationEleve.php");
						break;
					case "gestion" :
					...
					case "formulaire" :
						...
						break;
					case "formulaireEleve" :
						include ("VUES/formulaireEleve.php");
						break;						
					case "insertEleve" :
						include ("VUES/insertEleve.php");
						break;
					case "inserFic" :
						include ("VUES/inserFic.php");
						break;
					case "afficheEleve" :
						include ("VUES/afficheEleve.php");
						break;
					default :
